...
function getProductsWithStock(params) {
  ...
  var query;
  if (params.id === "all") {
    query = `select a.idProducto, a.codInterno, a.nombreProducto, a.codigoBarras, b.cant_Actual, a.precioDeFabrica from Productos a inner join Stock_Bodega b 
    on a.idProducto=b.idProducto where idBodega='${params.idAlmacen}' union 
    select  a.idProducto, a.codInterno, a.nombreProducto, a.codigoBarras, b.cant_Actual, a.precioDeFabrica from Productos a inner join Stock_Agencia b 
    on a.idProducto=b.idProducto where idAgencia='${params.idAlmacen}' union 
    select  a.idProducto, a.codInterno, a.nombreProducto, a.codigoBarras, b.cant_Actual, a.precioDeFabrica from Productos a inner join Stock_Agencia_Movil b 
    on a.idProducto=b.idProducto where idVehiculo='${params.idAlmacen}'`;
  } else {
    query = `select a.codInterno, a.nombreProducto, a.codigoBarras, b.cant_Actual from Productos a inner join Stock_Bodega b 
